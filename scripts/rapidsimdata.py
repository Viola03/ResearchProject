...
### TAKE RAPIDSIM TUPLES AND APPENDS CONDITIONAL INFORMATION FOR INFERENCE ###
...
file = '/users/zw21147/ResearchProject/datasets_mixed/full_mixed_Kee.root'

def extra_conditions(file_name):
    ### Takes a ROOT file and reformats it for inference according to expected conditions ###
...
output_file_path = "/users/zw21147/ResearchProject/datasets_mixed/full_mixed_Kee_newconditions.root"
