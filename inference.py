...
vertexing_network = network_manager(
					network="inference/models/vertexing_decoder_model.onnx", 
					config="inference/models/vertexing_configs.pkl", 
					transformers="inference/models/vertexing_transfomers.pkl", 
                    )

vertexing_encoder = network_manager(
					network="inference/models/vertexing_encoder_model.onnx", 
					config="inference/models/vertexing_configs.pkl", 
					transformers="inference/models/vertexing_transfomers.pkl", 
                    )
